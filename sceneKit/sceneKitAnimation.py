...
(
    ValueFunctionRotateX,
    ValueFunctionRotateY,
    ValueFunctionRotateZ,
    ValueFunctionScale,
    ValueFunctionScaleX,
    ValueFunctionScaleY,
    ValueFunctionScaleZ,
    ValueFunctionTranslate,
    ValueFunctionTranslateX,
    ValueFunctionTranslateY,
    ValueFunctionTranslateZ,
) = _CAValueFunctions
...
class Action(CInst):
    ...
    def rotateBy(cls, *args):
        if len(args) == 2 and len(args[0]) == 3:
            ...
            return rotateByAroundAxis(
                args[0], Vector3(args[1], args[2], args[3]), args[4]
            )
        else:
    ...
    def rotateTo(cls, *args, shortestUnitArc=None):
        if len(args) == 2 and len(args[0]) == 3:
            return RotateTo(
                ...
                args[0][2],
                args[1],
                shortestUnitArc=shortestUnitArc,
            )
        else:
...
class ActionTimingFunctionBlock(CInst):
    def __init__(self, block, ID=None):
        if ID is not None:
            ...
            self.ID = ObjCBlock(
                self.blockInterface, restype=c_float, argtypes=[c_void_p, c_float]
            )
            self.pCode = block
...
class RotateByAroundAxis(Action):
    def __init__(self, angle=0.0, axis=Vector3(0, 0, 0), duration=0.0):
        self.ID = SCNAction.rotateByAngle_aroundAxis_duration_(
            angle, vector3Make(axis), duration
        )
...
class RotateTo(Action):
    def __init__(self, x=0.0, y=0.0, z=0.0, duration=0.0, shortestUnitArc=None):
        if shortestUnitArc is None:
            ...
            self.ID = SCNAction.rotateToX_y_z_duration_shortestUnitArc_(
                x, y, z, duration, shortestUnitArc
            )


class RotateToAxisAngle(Action):
    def __init__(self, axisAngle=Vector4(0, 0, 0, 0), duration=0.0):
        self.ID = SCNAction.rotateToAxisAngle_duration_(
            vector4Make(axisAngle), duration
        )
...
class PlayAudioSource(Action):
    def __init__(self, source=None, wait=None, waitForCompletion=None):
        if waitForCompletion is not None:
...
class RunBlock(Action):
    def __init__(self, block):
        self.blockCode = ObjCBlock(
            self.blockInterface, restype=None, argtypes=[c_void_p, c_void_p]
        )
        self.pCode = block
...
class CustomActionWithDuration(Action):
    def __init__(self, duration=None, block=None, seconds=None, action=None):
        ...
        if block is None:
            block = action
        self.blockCode = ObjCBlock(
            self.blockInterface, restype=None, argtypes=[c_void_p, c_void_p, c_double]
        )
        self.pCode = block
        self.ID = SCNAction.customActionWithDuration_actionBlock_(
            duration, self.blockCode
        )
...
class Actionable:
    def runAction(
        self, action, forKey=None, completionHandler=None, key=None, block=None
    ):
        if block is not None:
            completionHandler = block
        if key is not None:
            forKey = key
        if ~isinstance(forKey, str) and completionHandler is None:
            completionHandler = forKey
        if forKey is None and completionHandler is None:
            ...
            self.ID.runAction_forKey_completionHandler_(
                action.ID, forKey, completionHandler
            )
...
class TransactionClass:
    ...
    animationTimingFunction = property(
        getAnimationTimingFunction, setAnimationTimingFunction
    )
...
class Animatable:
    ...
    def removeAnimationForKey(self, key, duration=0.0, blendOutDuration=None):
...
class Animation(CInst):
    def __init__(self, name=None, URL=None, caAnimation=None, ID=None):
        if name is not None:
            ...
            if isinstance(caAnimation, sceneKit.CoreAnimation):
                caAnimation = caAnimation.ID
    ...
    def getAnimationEvents(self):
        ...
        animationEvents = [
            sceneKit.AnimationEvent.outof(anEvent) for anEvent in animationEventsList
        ]
...
class AnimationDidStartBlock:
    def __init__(self, block):
        self.blockCode = ObjCBlock(
            self.blockInterface, restype=None, argtypes=[c_void_p, c_void_p, c_void_p]
        )
        self.pCode = block
    ...
    def blockInterface(self, _cmd, xAnimation, xReceiver):
        ...
        receiver = (
            sceneKit.CInst.outof(ObjCInstance(xReceiver))
            if xReceiver is not None
            else None
        )
...
class AnimationDidStopBlock:
    def __init__(self, block):
        self.blockCode = ObjCBlock(
            self.blockInterface,
            restype=None,
            argtypes=[c_void_p, c_void_p, c_void_p, c_bool],
        )
        self.pCode = block
...
class AnimationEvent(CInst):
    def __init__(self, time=0, block=None, eventBlock=None, ID=None):
        ...
        if block is not None:
            ...
            self.ID = SCNAnimationEvent.animationEventWithKeyTime_block_(
                time, self.blockCode
            )
            self.pCode = block
        elif ID is not None:
    ...
    @classmethod
    def animationEventWithKeyTime(cls, time=0.0, block=None, eventBlock=None):
...
class TimingFunction(CInst):
    def __init__(self, timingMode=None, aCoreMediaTimingFunction=None, ID=None):
        if timingMode is not None:
            ...
            self.ID = SCNTimingFunction.functionWithCAMediaTimingFunction_(
                aCoreMediaTimingFunction
            )
        elif ID is not None:
            self.ID = ID
        else:
...
class CoreMediaTimingFunction(CInst):
    def __init__(self, name=None, c1x=0.0, c1y=0.0, c2x=0.0, c2y=0.0, ID=None):
        if ID is not None:
            self.ID = ID
        elif name is not None:
            self.ID = CAMediaTimingFunction.functionWithName_(name)
        else:
            self.ID = CAMediaTimingFunction.functionWithControlPoints____(
                c1x, c1y, c2x, c2y
            )
    ...
    @classmethod
    def functionWithControlPoints(cls, c1x=0.0, c1y=0.0, c2x=0.0, c2y=0.0):
        return cls(c1x, c1y, c2x, c2y)

    def initWithControlPoints(self, c1x=0.0, c1y=0.0, c2x=0.0, c2y=0.0):
    ...
    def getControlPointAtIndex(self, idx=0):
        ...
        res_type = c_float * 2
        res = res_type()
        self.ID.getControlPointAtIndex_values_(
            cidx, byref(res), restype=None, argtypes=[c_int, POINTER(res_type)]
        )
        return tuple(res)
...
class CorePropertyAnimation:
    ...
    def setValueFunction(self, aFunc):
        if isinstance(aFunc, sceneKit.CoreValueFunction):
            aFunc = aFunc.ID
    ...
    def valueFromP(self, aValue):
        if isinstance(aValue, (int, float)):
            ...
            return NSValue.valueWithSCNVector4_(
                SCNVector4(aValue[0], aValue[1], aValue[2], self.vector3Indicator),
                restype=c_void_p,
                argtypes=[SCNVector4],
            )
        elif isinstance(aValue, (Vector4, Quaternion, SCNVector4)):
            return NSValue.valueWithSCNVector4_(
                SCNVector4(aValue[0], aValue[1], aValue[2], aValue[3]),
                restype=c_void_p,
                argtypes=[SCNVector4],
            )
        else:
...
class CoreAnimation(CInst, CorePropertyAnimation):
    ...
    def getDelegate(self):
        aCoreAnimationDelegate = sceneKit.CoreAnimationDelegate.outof(
            self.ID.delegate()
        )
    ...
    def getAnimationEvents(self):
        animationEventsList = self.ID.animationEvents()
        animationEvents = [
            sceneKit.AnimatioEvent.outof(anEvent) for anEvent in animationEventsList
        ]
        return tuple(animationEvents)
        ...
        if ID is not None:
            ...
            self.methods = [
                ...
                for _a in [
                    ...
                    for anAction in CoreAnimationDelegate._actions
                ]
            ]
...
class CoreAnimationGroup(CoreAnimation):
    ...
    def setAnimations(self, animList):
        try:
            ...
            animList = [animList]
        animListC = [
            anAnim.ID if isinstance(anAnim, CoreAnimation) else anAnim
            for anAnim in animList
        ]
