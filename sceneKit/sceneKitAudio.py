...
class AudioSource(CInst):
    ...
    def convertURL(self, url):
        pythonistaSoundDir = os.path.abspath(
            os.path.join(os.__file__, "../../../..") + "/Media/Sounds/"
        )
...
class AudioPlayer(CInst):
    ...
    @classmethod
    def audioPlayerWithAVAudioNode(
        cls, audioNode=None, AVAudioNode=None, avAudioNode=None
    ):
        if AVAudioNode is not None:
    ...
    def setWillStartPlayback(self, aBlock):
        self.audioSourceWillStartPlayback = AudioSourceWillStartStopPlaybackBlock(
            aBlock
        )
    ...
    def setDidFinishPlayback(self, aBlock):
        self.audioSourceDidFinishPlayback = AudioSourceWillStartStopPlaybackBlock(
            aBlock
        )
...
class AudioSourceWillStartStopPlaybackBlock:
    def __init__(self, block):
        self.blockCode = ObjCBlock(
            self.blockInterface, restype=None, argtypes=[c_void_p]
        )
        self.pCode = block
