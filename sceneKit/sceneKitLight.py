...
class Light(Animatable, CInst):
    ...
    attenuationStartDistance = property(
        getAttenuationStartDistance, setAttenuationStartDistance
    )
    ...
    attenuationEndDistance = property(
        getAttenuationEndDistance, setAttenuationEndDistance
    )
    ...
    attenuationFalloffExponent = property(
        getAttenuationFalloffExponent, setAttenuationFalloffExponent
    )
    ...
    automaticallyAdjustsShadowProjection = property(
        getAutomaticallyAdjustsShadowProjection, setAutomaticallyAdjustsShadowProjection
    )
    ...
    sampleDistributedShadowMaps = property(
        getSampleDistributedShadowMaps, setSampleDistributedShadowMaps
    )
    ...
    shadowCascadeSplittingFactor = property(
        getShadowCascadeSplittingFactor, setShadowCascadeSplittingFactor
    )
