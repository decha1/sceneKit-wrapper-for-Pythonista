...
(
    LightingModelBlinn,
    LightingModelConstant,
    LightingModelLambert,
    LightingModelPhong,
    LightingModelPhysicallyBased,
) = _lightingModels
...
class Material(Animatable, CInst):
    ...
    locksAmbientWithDiffuse = property(
        getLocksAmbientWithDiffuse, setLocksAmbientWithDiffuse
    )
