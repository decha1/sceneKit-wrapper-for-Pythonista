...
(
    ...
    ParticlePropertyAngularVelocity,
    ParticlePropertyBounce,
    ParticlePropertyCharge,
    ParticlePropertyColor,
    ParticlePropertyContactNormal,
    ParticlePropertyContactPoint,
    ParticlePropertyFrame,
    ParticlePropertyFrameRate,
    ParticlePropertyFriction,
    ParticlePropertyLife,
    ParticlePropertyOpacity,
    ParticlePropertyPosition,
    ParticlePropertyRotationAxis,
...
class ParticleSystem(Animatable, CInst):
    def __init__(self, name=None, directory=None, ID=None):
        ...
        if ID is not None:
            ...
            self.ID = SCNParticleSystem.particleSystemNamed_inDirectory_(
                name, directory
            )
        else:
    ...
    emissionDurationVariation = property(
        getEmissionDurationVariation, setEmissionDurationVariation
    )
    ...
    particleAngleVariation = property(
        getParticleAngleVariation, setParticleAngleVariation
    )
    ...
    particleVelocityVariation = property(
        getParticleVelocityVariation, setParticleVelocityVariation
    )
    ...
    particleAngularVelocity = property(
        getParticleAngularVelocity, setParticleAngularVelocity
    )
    ...
    particleAngularVelocityVariation = property(
        getParticleAngularVelocityVariation, setParticleAngularVelocityVariation
    )
    ...
    particleLifeSpanVariation = property(
        getParticleLifeSpanVariation, setParticleLifeSpanVariation
    )
    ...
    particleColorVariation = property(
        getParticleColorVariation, setParticleColorVariation
    )
    ...
    imageSequenceColumnCount = property(
        getImageSequenceColumnCount, setImageSequenceColumnCount
    )
    ...
    imageSequenceInitialFrame = property(
        getImageSequenceInitialFrame, setImageSequenceInitialFrame
    )
    ...
    imageSequenceInitialFrameVariation = property(
        getImageSequenceInitialFrameVariation, setImageSequenceInitialFrameVariation
    )
    ...
    imageSequenceFrameRate = property(
        getImageSequenceFrameRate, setImageSequenceFrameRate
    )
    ...
    imageSequenceFrameRateVariation = property(
        getImageSequenceFrameRateVariation, setImageSequenceFrameRateVariation
    )
    ...
    imageSequenceAnimationMode = property(
        getImageSequenceAnimationMode, setImageSequenceAnimationMode
    )
    ...
    affectedByPhysicsFields = property(
        getAffectedByPhysicsFields, setAffectedByPhysicsFields
    )
    ...
    particleDiesOnCollision = property(
        getParticleDiesOnCollision, setParticleDiesOnCollision
    )
    ...
    particleChargeVariation = property(
        getParticleChargeVariation, setParticleChargeVariation
    )
    ...
    particleBounceVariation = property(
        getParticleBounceVariation, setParticleBounceVariation
    )
    ...
    particleFrictionVariation = property(
        getParticleFrictionVariation, setParticleFrictionVariation
    )
    ...
    systemSpawnedOnCollision = property(
        getSystemSpawnedOnCollision, setSystemSpawnedOnCollision
    )
    ...
    particleIntensityVariation = property(
        getParticleIntensityVariation, setParticleIntensityVariation
    )
    ...
    def blockEnabler(self, prop):
        ...
        small = 0.0000001
        if prop == ParticlePropertyAngle and abs(self.particleAngleVariation) < small:
            self.particleAngleVariation = small
        elif (
            prop == ParticlePropertyAngularVelocity
            and abs(self.particleAngularVelocityVariation) < small
        ):
            self.particleAngularVelocityVariation = small
        elif (
            prop == ParticlePropertyBounce and abs(self.particleBounceVariation) < small
        ):
            self.particleBounceVariation = small
        elif (
            prop == ParticlePropertyCharge and abs(self.particleChargeVariation) < small
        ):
            self.particleChargeVariation = small
        elif (
            prop == ParticlePropertyColor
            and (
                self.particleColorVariation[0] ** 2
                + self.particleColorVariation[1] ** 2
                + self.particleColorVariation[2] ** 2
                + self.particleColorVariation[3] ** 2
            )
            < small
        ):
            self.particleColorVariation = Vector4(0.0, 0.0, 0.0, small)
        elif (
            prop == ParticlePropertyFrame
            and abs(self.imageSequenceInitialFrameVariation) < small
        ):
            self.imageSequenceInitialFrameVariation = small
        elif prop == ParticlePropertyFrameRate and abs(
            self.imageSequenceFrameRateVariation < small
        ):
            self.imageSequenceFrameRateVariation = small
        elif prop == ParticlePropertyFriction and abs(
            self.particleFrictionVariation < small
        ):
            self.particleFrictionVariation = small
        elif (
            prop == ParticlePropertyLife and abs(self.particleLifeSpanVariation) < small
        ):
            self.particleLifeSpanVariation = small
        elif prop == ParticlePropertySize and abs(self.particleSizeVariation) < small:
            self.particleSizeVariation = small
        elif (
            prop == ParticlePropertyVelocity
            and abs(self.particleVelocityVariation) < small
        ):
            self.particleVelocityVariation = small
    ...
    def handleEvent(
        ...
        if block is None and withBlock is not None:
            block = withBlock
        try:
    ...
    def addModifierForProperties(
        ...
        self.ID.addModifierForProperties_atStage_withBlock_(
            properties, stage.value, blockInstance.blockCode
        )
    ...
    def removeModifiersOfStage(self, stage=None, ofStage=None):
        if stage is None:
            stage = ofStage
        self.particleModifierBlocks = [
            aBlock for aBlock in self.particleModifierBlocks if aBlock.stage != stage
        ]
    ...
    def blockInterface(self, _cmd, xData, dataStride, start, end, deltaTime):
        for particleIndex in range(start, end):
            for aPropertyIndex in range(self.propertyNumber):
                ...
                prop = cast(propAddr, POINTER(c_float))
                self.pCode(
                    prop, self.properties[aPropertyIndex], particleIndex, deltaTime
                )
