...
class Camera(Animatable, CInst):
    ...
    automaticallyAdjustsZRange = property(
        getAutomaticallyAdjustsZRange, setAutomaticallyAdjustsZRange
    )
    ...
    usesOrthographicProjection = property(
        getUsesOrthographicProjection, setUsesOrthographicProjection
    )
    ...
    wantsExposureAdaptation = property(
        getWantsExposureAdaptation, setWantsExposureAdaptation
    )
    ...
    exposureAdaptationBrighteningSpeedFactor = property(
    ...
    exposureAdaptationDarkeningSpeedFactor = property(
    ...
    screenSpaceAmbientOcclusionIntensity = property(
        getScreenSpaceAmbientOcclusionIntensity, setScreenSpaceAmbientOcclusionIntensity
    )
    ...
    screenSpaceAmbientOcclusionRadius = property(
        getScreenSpaceAmbientOcclusionRadius, setScreenSpaceAmbientOcclusionRadius
    )
    ...
    screenSpaceAmbientOcclusionBias = property(
        getScreenSpaceAmbientOcclusionBias, setScreenSpaceAmbientOcclusionBias
    )
    ...
    screenSpaceAmbientOcclusionDepthThreshold = property(
    ...
    screenSpaceAmbientOcclusionNormalThreshold = property(
...
class CameraControlConfiguration(CInst):
    ...
    autoSwitchToFreeCamera = property(
        getAutoSwitchToFreeCamera, setAutoSwitchToFreeCamera
    )
...
class CameraController(CInst):
    ...
    def getDelegate(self):
        aCameraControllerDelegate = sceneKit.CameraControllerDelegate.outof(
            self.ID.delegate()
        )
    ...
    maximumHorizontalAngle = property(
        getMaximumHorizontalAngle, setMaximumHorizontalAngle
    )
    ...
    minimumHorizontalAngle = property(
        getMinimumHorizontalAngle, setMinimumHorizontalAngle
    )
    ...
    def continueInteraction(self, location=None, withViewport=None, sensitivity=None):
        self.ID.continueInteraction_withViewport_sensitivity_(
            location, withViewport, sensitivity
        )
...
def cameraInertiaDidEndForController_(_self, _cmd, cameraController):
    ...
    if aCameraControllerDelegate.methods[0]:
        aCameraController = sceneKit.CameraController.outof(
            ObjCInstance(cameraController)
        )
...
class CameraControllerDelegate(CInst):
    ...
    _cMethodList = [
        cameraInertiaDidEndForController_,
        cameraInertiaWillStartForController_,
    ]
        ...
        if ID is not None:
            ...
            self.methods = [
                ...
                for _a in [
                    ...
                    for anAction in CameraControllerDelegate._actions
                ]
            ]
            self.ID = (
                CameraControllerDelegate.DelegateCClass.alloc().init().autorelease()
            )
